...
def project_list
  project_list = [
    ...
    { a: 3, type: :library  , key: :customer_management_api_models              , name: 'CustomerManagement.Api.Models'                                             },
    { a: 3, type: :library  , key: :customer_management_api_dal                 , name: 'CustomerManagement.Api.Dal'                  , variant: :entity_framework  },
    { a: 3, type: :library  , key: :customer_management_api_business            , name: 'CustomerManagement.Api.Business'                                           },
    { a: 3, type: :webapi   , key: :customer_management_api_rest                , name: 'CustomerManagement.Api'                                                    },
    { a: 1, type: :webapi   , key: :customer_management_api                     , name: 'CustomerManagement.Api'                                                    },
